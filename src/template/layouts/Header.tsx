                    ...
                    <div className="header__brand">
                        <div className="brand-wrap">
                            ...
                            <a href="#" className="brand-img stretched-link">
                                <img src="./assets/img/logo.svg" alt="Nifty Logo" className="Nifty logo" width="40"
                                     height="40" />
                            </a>
                        ...
                        <div className="header__content-start">
                            ...
                            <div className="header-searchbox">
                                ...
                                <label htmlFor="header-search-input"
                                    ...
                                    <i className="psi-magnifi-glass"/>
                                </label>

   
                                <form className="searchbox searchbox--auto-expand searchbox--hide-btn input-group">
                                    <input id="header-search-input"
                                           className="searchbox__input form-control bg-transparent" type="search"
                        ...
                        <div className="header__content-end">
                            ...
                            <div className="dropdown">
                                ...
                                <button className="header__btn btn btn-icon btn-sm" type="button"
                                        ...
                                        aria-label="Megamenu dropdown" aria-expanded="false">
                                    <i className="psi-layout-grid"/>
                                </button>
                                    ...
                                    <div className="row">
                                        <div className="col-md-3">
                                            ...
                                            <div className="list-group list-group-borderless">
                                                <div
                                                    className="list-group-item d-flex align-items-center border-bottom mb-2">
                                                    <div className="flex-shrink-0 me-2">
                                                        <i className="pli-file fs-4"/>
                                                    </div>
                                                    <h5 className="flex-grow-1 m-0">Pages</h5>
                                                </div>
                                                <a href="#"
                                                   className="list-group-item list-group-item-action">Profile</a>
                                                <a href="#" className="list-group-item list-group-item-action">Search
                                                    Result</a>
                                                <a href="#" className="list-group-item list-group-item-action">FAQ</a>
                                                <a href="#" className="list-group-item list-group-item-action">Screen
                                                    Lock</a>
                                                <a href="#"
                                                   className="list-group-item list-group-item-action">Maintenance</a>
                                                <a href="#"
                                                   className="list-group-item list-group-item-action">Invoices</a>
                                                <a href="#" className="list-group-item list-group-item-action disabled"
                                                aria-disabled="true">Disabled Item</a>
                                            </div>
                                        ...
                                        <div className="col-md-3">
                                            ...
                                            <div className="list-group list-group-borderless mb-3">
                                                ...
                                                <a href="#" className="list-group-item list-group-item-action">Read
                                                    Messages</a>
                                                <a href="#"
                                                   className="list-group-item list-group-item-action">Compose</a>
                                                <a href="#"
                                                   className="list-group-item list-group-item-action">Template</a>
                                            </div>
                                            ...
                                            <div className="list-group list-group-borderless">
                                                <div
                                                    ...
                                                    <div className="flex-shrink-0 me-2">
                                                        <i className="pli-calendar-4 fs-4"/>
                                                    </div>
                                            ...
                                            <div className="list-group list-group-borderless">
                                                <div
                                                    ...
                                                    <div className="flex-shrink-0 me-3">
                                                        <i className="pli-data-settings fs-2"/>
                                                    </div>
                                                    <div className="flex-grow-1 ">
                                                        <div
                                                            className="d-flex justify-content-between align-items-start">
                                                            <a href="#"
                                                               className="h6 d-block mb-1 stretched-link text-decoration-none">Data
                                                                Backup</a>
                                                            <span
                                                                className="badge bg-success rounded-pill ms-auto">40%</span>
                                                        </div>
                                                        <small className="text-muted">Current usage of disks for
                                                            backups.</small>
                                                    </div>
                                                </div>
                                                ...
                                                <div
                                                    className="list-group-item list-group-item-action d-flex align-items-start mb-3">
                                                    <div className="flex-shrink-0 me-3">
                                                        <i className="pli-support fs-2"/>
                                                    </div>
                                                    <div className="flex-grow-1 ">
                                                        <a href="#"
                                                           className="h6 d-block mb-1 stretched-link text-decoration-none">Support</a>
                                                        <small className="text-muted">Have any questions ? please don't
                                                ...
                                                <div
                                                    className="list-group-item list-group-item-action d-flex align-items-start mb-3">
                                                    <div className="flex-shrink-0 me-3">
                                                        <i className="pli-computer-secure fs-2"/>
                                                    </div>
                                                    <div className="flex-grow-1 ">
                                                        <a href="#"
                                                           className="h6 d-block mb-1 stretched-link text-decoration-none">Security</a>
                                                        <small className="text-muted">Our devices are secure and
                                                            up-to-date.</small>
                                                    </div>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <div className="flex-shrink-0 me-3">
                                                        <i className="pli-map-2 fs-2"/>
                                                    </div>
                                                    <div className="flex-grow-1 ">
                                                        <a href="#"
                                                           className="h6 d-block mb-1 stretched-link text-decoration-none">Location</a>
                                                        <small className="text-muted">From our location up here, we kept
                                                            in close touch.</small>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="d-grid gap-2 ps-5 pe-2">
                                                <div className="row g-1 rounded-3 overflow-hidden">
                                                    <div className="col-6 mt-0">
                                                        <img className="img-fluid" src="./assets/img/megamenu/img-1.jpg"
                                                             alt="thumbnails" loading="lazy" />
                                                    </div>
                                                    <div className="col-6 mt-0">
                                                        <img className="img-fluid" src="./assets/img/megamenu/img-3.jpg"
                                                             alt="thumbnails" loading="lazy" />
                                                    </div>
                                                    <div className="col-6">
                                                        <img className="img-fluid" src="./assets/img/megamenu/img-2.jpg"
                                                             alt="thumbnails" loading="lazy" />
                                                    </div>
                                                    <div className="col-6">
                                                        <img className="img-fluid" src="./assets/img/megamenu/img-4.jpg"
                                                             alt="thumbnails" loading="lazy" />
                                                    </div>
                                                    <div className="col-6">
                                                        <img className="img-fluid" src="./assets/img/megamenu/img-6.jpg"
                                                             alt="thumbnails" loading="lazy" />
                                                    </div>
                                                    <div className="col-6">
                                                        <img className="img-fluid" src="./assets/img/megamenu/img-5.jpg"
                                                             alt="thumbnails" loading="lazy" />
                                                    </div>
                                                </div>
                                ...
                                <div className="dropdown-menu dropdown-menu-end w-md-300px">
                                    ...
                                    <div className="list-group list-group-borderless">
                                        ...
                                        <div
                                            ...
                                            <div className="flex-grow-1 ">
                                                <a href="#"
                                                   className="h6 d-block mb-0 stretched-link text-decoration-none">Your
                                                    storage is full</a>
                                        ...
                                        <div
                                            className="list-group-item list-group-item-action d-flex align-items-start mb-3">
                                            <div className="flex-shrink-0 me-3">
                                                <i className="psi-file-edit text-blue-200 fs-2"/>
                                            </div>
                                            <div className="flex-grow-1 ">
                                                <a href="#"
                                                   className="h6 d-block mb-0 stretched-link text-decoration-none">Writing
                                                    a New Article</a>
                                                <small className="text-muted">Wrote a news article for the John
                                                    Mike</small>
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            className="list-group-item list-group-item-action d-flex align-items-start mb-3">
                                            <div className="flex-shrink-0 me-3">
                                                <i className="psi-speech-bubble-7 text-green-300 fs-2"/>
                                            </div>
                                            <div className="flex-grow-1 ">
                                                <div className="d-flex justify-content-between align-items-start">
                                                    <a href="#" className="h6 mb-0 stretched-link text-decoration-none">Comment
                                                        sorting</a>
                                        ...
                                        <div
                                            ...
                                            <div className="flex-grow-1 ">
                                                <a href="#"
                                                   className="h6 d-block mb-0 stretched-link text-decoration-none">Lucy
                                        ...
                                        <div
                                            ...
                                            <div className="flex-grow-1 ">
                                                <a href="#"
                                                   className="h6 d-block mb-0 stretched-link text-decoration-none">Jackson
                                                    Sent you a message</a>
                                    ...
                                    <div className="row">
                                        <div className="col-md-7">
                                            ...
                                            <div className="list-group list-group-borderless mb-3">
                                                <div className="list-group-item text-center border-bottom mb-3">
                                                    ...
                                                    <p className="h6 mb-0"><i
                                                        className="pli-basket-coins fs-3 me-2"/> New orders</p>
                                        ...
                                        <div className="col-md-5">
                                            ...
                                            <div className="list-group list-group-borderless h-100 py-3">
                                                <a href="#"
                                                   className="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                                                    <span><i className="pli-mail fs-5 me-2"/> Messages</span>
                                                    <span className="badge bg-danger rounded-pill">14</span>
                                                </a>
                                                <a href="#" className="list-group-item list-group-item-action">
                                                    <i className="pli-male fs-5 me-2"/> Profile
                                                </a>
                                                <a href="#" className="list-group-item list-group-item-action">
                                                    <i className="pli-gear fs-5 me-2"/> Settings
                                                </a>

                                                <a href="#" className="list-group-item list-group-item-action mt-auto">
                                                    <i className="pli-computer-secure fs-5 me-2"/> Lock screen
                                                </a>
                                                <a href="#" className="list-group-item list-group-item-action">
                            ...
                            <button className="sidebar-toggler header__btn btn btn-icon btn-sm" type="button"
                                    aria-label="Sidebar button">
                                <i className="psi-dot-vertical"/>
                            </button>
