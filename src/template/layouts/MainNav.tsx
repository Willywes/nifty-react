                    ...
                    <div className="mainnav__top-content scrollable-content pb-5">
                        ...
                        <div className="mainnav__profile mt-3 d-flex3">
                            ...
                            <div className="mininav-toggle text-center py-2">
                                <img className="mainnav__avatar img-md rounded-circle border"
                            ...
                            <div className="mininav-content collapse d-mn-max">
                                <div className="d-grid">
                                    ...
                                    <button className="d-block btn shadow-none p-2" data-bs-toggle="collapse"
                                    ...
                                    <div id="usernav" className="nav flex-column collapse">
                                        <a href="#"
                                           className="nav-link d-flex justify-content-between align-items-center">
                                            <span><i className="pli-mail fs-5 me-2"/><span
                                                className="ms-1">Messages</span></span>
                                            <span className="badge bg-danger rounded-pill">14</span>
                                        </a>
                                        <a href="#" className="nav-link">
                                            <i className="pli-male fs-5 me-2"/><span className="ms-1">Profile</span>
                                        </a>
                                        <a href="#" className="nav-link">
                                            <i className="pli-gear fs-5 me-2"/><span className="ms-1">Settings</span>
                                        </a>
                                        <a href="#" className="nav-link">
                                            <i className="pli-computer-secure fs-5 me-2"/><span className="ms-1">Lock screen</span>
                                        </a>
                                        <a href="#" className="nav-link">
                                            <i className="pli-unlock fs-5 me-2"/><span className="ms-1">Logout</span>
                                        </a>
                                    </div>
                        ...
                        <div className="mainnav__categoriy py-3">
                            ...
                            <ul className="mainnav__menu nav flex-column">
                                ...
                                <li className="nav-item">
                                    <a href="#" className="nav-link mininav-toggle collapsed"><i
                                        className="pli-bar-chart fs-5 me-2"/>
                                        <span className="nav-label mininav-content ms-1">Regular</span>
                                    </a>
                                </li>

                                <li className="nav-item">
                                    <a href="#" className="nav-link mininav-toggle collapsed active"><i
                                ...
                                <li className="nav-item">
                                    <a href="#" className="nav-link mininav-toggle collapsed">
                                        <i className="pli-roller fs-5 me-2"/>
                            ...
                            <ul className="mainnav__menu nav flex-column">
                                ...
                                <li className="nav-item has-sub">
                                    ...
                                    <a href="#" className="mininav-toggle nav-link">
                                        <i className="pli-data-center fs-5 me-2"/>
                                ...
                                <li className="nav-item has-sub">
                                    ...
                                    <a href="#" className="mininav-toggle nav-link active">
                                        <i className="pli-idea fs-5 me-2"/>
                                ...
                                <li className="nav-item has-sub">
                                    ...
                                    <a href="#" className="mininav-toggle nav-link">
                                        <i className="pli-pizza-slice fs-5 me-2"/>
                        ...
                        <div className="mainnav__categoriy py-3">
                            ...
                            <ul className="mainnav__menu nav flex-column">
                                <li className="nav-item has-sub">
                                    ...
                                    <a href="#" className="mininav-toggle nav-link collapsed"><i
                                        className="pli-tactic fs-5 me-2"/>
                        ...
                        <ul id="mainnav" className="mainnav__menu nav flex-column">
                            <li className="nav-item has-sub">
                                ...
                                <ul className="mininav-content nav flex-column collapse">
                                    ...
                                    <li className="nav-item">
                                        <a className="nav-link disabled" href="#" tabIndex={-1} aria-disabled="true">Lock
                                            screen</a>
                                    </li>
                                </ul>
                            </li>
